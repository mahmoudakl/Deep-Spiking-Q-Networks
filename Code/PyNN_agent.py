...
class PyNNAgent:
    ...
    def __init__(self, architecture, file, simulation_time, backend='spinnaker',
        ...
        :param has_biases: whether the loaded network has biases, if yes loading looks slightly
                           different
        """
